...
# The ChatConsumer that we have written is currently synchronous.( Using async_to_sync() ) 
...
# However asynchronous consumers can provide a higher level of performance since they don’t need to create additional threads 
...
# CALLBACK() is invoked after the first function if that first function completes
            ...
            if lobbystatus is False:
                ...
                await self.channel_layer.group_send(
                    self.lobbynome,
                    {
                        ...
                        'botname': botname,
                        'conteudo': 'O bot já está criando sua partida.',
